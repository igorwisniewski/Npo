    ...
    return (
        <footer className="bg-neutral-900 text-white py-10  z-10">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 className="font-bold text-lg mb-2">Narodowy Program Oddłużania</h3>
                ...
                <div>
                    ...
                    <p className="text-sm">tel: +48 793 055 911<br />email: kontakt@narodowyprogramoddluzan.pl</p>
                </div>
            </div>
