...
export default function MissionValuesSection({ customColor }) {
    // Klasy dla przycisku z ramką w kolorze customColor.
    const borderedButtonClasses = `border-[${customColor}] border-2 text-[${customColor}] hover:bg-red-50 font-bold py-3 px-6 rounded-sm shadow-lg transition duration-300 ease-in-out cursor-pointer`;
        ...
        <div className="w-full bg-white py-20 px-6 lg:px-12 xl:px-24 flex flex-col-reverse lg:flex-row items-center justify-center gap-10 md:gap-16">
            ...
            <div className="w-full lg:w-[50%] flex flex-col items-center lg:items-start justify-center gap-6 sm:gap-8 text-center lg:text-left">
                ...
                <div className="flex gap-4 mt-4">
                    <button className={`bg-[${customColor}] hover:bg-[#5a0604] text-white font-bold py-3 px-6 rounded-sm shadow-lg transition duration-300 ease-in-out cursor-pointer`}>Zadzwoń</button>
